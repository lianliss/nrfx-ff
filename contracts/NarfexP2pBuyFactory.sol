...
contract NarfexP2pBuyFactory is Ownable {
    ...
    function create(address _fiatAddress, uint16 _commission, uint _minTradeAmount, uint _maxTradeAmount) public {
        ...
        NarfexP2pBuyOffer offer = new NarfexP2pBuyOffer(address(this), msg.sender, _fiatAddress, _commission, _minTradeAmount, _maxTradeAmount);
